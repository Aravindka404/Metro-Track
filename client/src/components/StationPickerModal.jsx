      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4 pointer-events-auto">
          ...
          <motion.div
            ...
            className={`relative w-full sm:max-w-lg border rounded-t-3xl sm:rounded-2xl shadow-2xl overflow-hidden max-h-[80vh] sm:max-h-[75vh] flex flex-col z-10 ${
          ...
          >
                ...
                <div
                  className={`w-3 h-3 rounded-full ${
                    isDestination
                      ...
                      : isLight
                      ? 'bg-teal-600 shadow-[0_0_8px_rgba(15,118,110,0.6)]'
            ...
            <div
              className={`overflow-y-auto divide-y p-2 sm:p-3 flex-1 overscroll-contain ${
                ...
                return (
                  <button
                    ...
                    className={`w-full px-3.5 py-3 rounded-xl flex items-center justify-between text-left transition-all ${
                      isSelected
                        ? isLight
                          ? 'bg-teal-50 border border-teal-500/40'
                    ...
                    <div className="flex items-center gap-3 min-w-0">
                      ...
                      <div
                        className={`w-7 h-7 rounded-lg flex items-center justify-center font-mono text-xs font-bold shrink-0 ${
                          isSelected
                            ? isLight
                              ? 'bg-teal-600 text-white shadow-[0_0_10px_rgba(15,118,110,0.4)]'
            ...
            {/* Footer */}
            <div
              className={`p-3 border-t text-center font-sans text-[11px] ${
                isLight
